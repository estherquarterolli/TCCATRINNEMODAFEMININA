...
<div id="demo" class="carousel slide" data-bs-ride="carouselp" >
    ...
    <section class="product">
      <h2 class="product-category">ENCONTRE O QUE VOCÊ PROCURA...</h2>
      ...
      <div class="product-card">
            ...
            <A href="BLUSAS.HTML" STYLE="text-decoration: NONE;COLOR:BLACK;">
                  <img src="imagenstcc/tipoblusa.png" class="product-thumb" alt="">
                 
              </div>
              <div class="product-info">
                
                  <CENTER><h2 class="product-brand">Blusas</h2></CENTER>
...
<A href="#" STYLE="text-decoration: NONE;COLOR:BLACK;">
      <img src="imagenstcc/TIPODEROUPASHORT.jpg" class="product-thumb" alt="">
...
<div class="product-card">
  <div class="product-image-type">
<A href="#" STYLE="text-decoration: NONE;COLOR:BLACK;">
      <img src="imagenstcc/TIPODEROUPACONJUNTO.jpg" class="product-thumb" alt="">
     
  </div>
  <div class="product-info">
    
      <CENTER><h2 class="product-brand">CONJUNTOS</h2></CENTER>
...
<div class="product-card">
  <div class="product-image-type">
<A href="#" STYLE="text-decoration: NONE;COLOR:BLACK;">
      <img src="imagenstcc/TIPODEROUPAVESTIDO.jpg" class="product-thumb" alt="">
...
<div class="product-card">
  <div class="product-image-type">
<A href="#" STYLE="text-decoration: NONE;COLOR:BLACK;">
      <img src="imagenstcc/TIPODEROUPAMACACAO.jpg" class="product-thumb" alt="">
...
<div class="product-card">
  <div class="product-image-type">
<A href="#" STYLE="text-decoration: NONE;COLOR:BLACK;">
      <img src="imagenstcc/TIPODEROUPACALÇA.jpg" class="product-thumb" alt="">
...
<div class="product-card">
                <div class="product-image">
                    ...
                    <img src="imagenstcc/blusa.png" class="product-thumb" alt="">
                    <button class="card-btn"><a href="#"><ion-icon name="cart-outline"></ion-icon></a></button>
                </div>
                <div class="product-info">
                  <div class="estrelas-favoritar">
                  <div class="avaliative-stars" style="display: flex; flex-direction: row; color: aqua;">
                    ...
                    <div class="coracao-favoritar">
                    <a href="#"><ion-icon name="heart-outline"></ion-icon></a>
                  </div>
                </div>
                    <h2 class="product-brand">Blusa Bonita</h2>
                    <p class="product-short-description">blusa linda e maravilhosa</p>
                    <span class="price">R$60,00</span><span class="actual-price">$40</span>
                </div>
 </div><!--fim produto -->
<div class="product-card">
              <div class="product-image">
