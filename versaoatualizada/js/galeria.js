...
function filterProduct(value) {
  ...
  elements.forEach((element) => {
    ...
    if (value == "all") {
      ...
      //checagem dos elementos nas classes
      if (element.classList.contains(value)) {
        //mostrar elementos baseados em sua categoria
        element.classList.remove("hide");
      } else {
...
document.getElementById("search").addEventListener("click", () => {
  ...
  elements.forEach((element, index) => {
    //checar se o valor incluso existe
...
//inicializar mopstrando todos os produtos, ao carregar a página
window.onload = () => {
  filterProduct("all");
};
