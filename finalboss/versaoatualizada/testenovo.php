...
<div class="filtros">
      ...
      <form method="post" action="">
            <input class="filtro-btn" type="submit" name="categoria" value="BLUSA" >
            <input class="filtro-btn"type="submit" name="categoria" value="CALÇA" >
        </form>
...
<button type="submit" name="categoria" value="CALÇA" >Filtrar Pesquisa</button>
        ...
        if(isset($_POST['categoria'])){
            ...
            switch ($categoria) {
                case 'BLUSA':
                    // Pesquisa de produtos na categoria blusa
                    $select_products = mysqli_query($conn, "select * from `products` where `type` = 'BLUSA' ");
                    break;
                case 'CALÇA':
                    // Pesquisa de produtos na categoria calça
                    $select_products = mysqli_query($conn, "select * from `products` where `type` = 'CALÇA' ");
                    break;
            }
